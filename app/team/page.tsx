  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 bg-black relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Wolf Krammel */}
        <ScrollReveal>
          <section className="mb-16 bg-gray-900 border-2 border-red-600 rounded-lg p-8 md:p-12 hover:border-red-500 transition-colors">
        ...
        <ScrollReveal delay={0.3}>
          <section className="bg-gray-900 border-2 border-red-600 rounded-lg p-8 md:p-12 hover:border-red-500 transition-colors">
