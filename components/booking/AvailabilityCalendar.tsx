  ...
  return (
    <div className="space-y-6 rounded-2xl border border-white/10 bg-white/5 p-6">
      ...
      <div>
        ...
        {loading ? (
          <div className="flex items-center gap-2 rounded-lg bg-black/20 px-4 py-8 text-sm text-gray-400">
          ...
          <div className="rounded-lg bg-black/20 px-4 py-8 text-center text-sm text-gray-400">
            <svg className="mx-auto mb-2 h-8 w-8 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
