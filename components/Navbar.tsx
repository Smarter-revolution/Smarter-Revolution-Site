  ...
  return (
    <>
      ...
      <div
        ref={menuRef}
        id="mobile-menu"
        className="fixed top-0 right-0 w-80 max-w-[85vw] bg-black border-l-2 border-red-600 md:hidden flex flex-col"
        style={{ 
          height: '100vh', 
          maxHeight: '100vh',
          zIndex: 9999,
      ...
      >
        ...
        <nav
          className="flex-1 overflow-y-auto overflow-x-hidden p-4 space-y-1 bg-black"
          style={{ 
            minHeight: 0,
            display: 'block',
            visibility: 'visible',
